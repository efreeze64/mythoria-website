    ...
    <footer>
      <div className="box">
        <div className="inner-box" id="left">
          <ul>
            <li>CONTACT:</li>
            <Link href="mailto:band@mythoria.dk">
              <li>band@mythoria.dk</li>
            </Link>
            <li>+45 23 74 60 63</li>
          </ul>
        </div>
        <div className="inner-box" id="middle-pc">
          <Link href="/">
            <img src={mythoria.src} className="logo" />
          </Link>
        </div>
        <div className="inner-box" id="middle-mobile">
          <Link href="/">
            <img src={icon.src} className="logo" />
          </Link>
        </div>
